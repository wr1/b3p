...
def main():
    ...
    build_parser.add_argument("--no-bondline", action="store_false", dest="bondline", help="Exclude bondline")
    ...
    build_geometry_parser.add_argument("yml_sub", type=Path, help="Path to YAML config file", nargs="?", default=None)

    build_mesh_parser = build_subparsers.add_parser("mesh", help="Mesh blade structure")
    build_mesh_parser.add_argument("yml_sub", type=Path, help="Path to YAML config file", nargs="?", default=None)

    build_drape_parser = build_subparsers.add_parser("drape", help="Drape plies onto mesh")
    build_drape_parser.add_argument("yml_sub", type=Path, help="Path to YAML config file", nargs="?", default=None)
    ...
    build_mass_parser.add_argument("yml_sub", type=Path, help="Path to YAML config file", nargs="?", default=None)

    build_apply_loads_parser = build_subparsers.add_parser("apply-loads", help="Apply loads to mesh")
    build_apply_loads_parser.add_argument("yml_sub", type=Path, help="Path to YAML config file", nargs="?", default=None)
